...
| `forge-llm-performance-roadmap` | planning | `docs/specs/planning/forge-llm-performance-roadmap.md` | `signet-runtime` | - | Forge harness parity roadmap for agent-loop reliability, provider/tool orchestration, policy-aware controls, and telemetry surfaces |
