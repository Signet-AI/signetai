...
- **run** acquires the migration lease, drains supported writers, copies regular files and in-boundary symlinks with verification, snapshots and verifies SQLite, then publishes v2 cutover.
