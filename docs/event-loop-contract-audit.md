...
- Exact ledger inventory: 812 sites
...
- `obsidian-source-embeddings.ts:601` (withWriteTx)
- `obsidian-source-embeddings.ts:647` (withReadDb)
- `obsidian-source-embeddings.ts:670` (withWriteTx)
