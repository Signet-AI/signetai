...
- `database-integrity.ts:576` (withWriteTxAsync)
- `database-integrity.ts:737` (withReadDbAsync)
- `database-integrity.ts:855` (withReadDbAsync)
...
- `startup-recovery.ts:84` (withWriteTxAsync)
- `startup-recovery.ts:106` (withReadDbAsync)
- `startup-recovery.ts:527` (withReadDbAsync)
