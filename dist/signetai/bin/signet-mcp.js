...
const target = join(packageDir, "runtime", "rust-daemon", `${process.platform}-${process.arch}`, binary);
...
child.on("error", (error) => { console.error(`Failed to start signet-mcp: ${error.message}`); process.exit(1); });
