...
import { verifyPackagedArtifactProvenance } from "./native-artifact-provenance";
...
verifyPackagedArtifactProvenance(
	{ artifact: binary, checkout: process.cwd(), cargoLock: join(process.cwd(), "platform/rust-daemon/Cargo.lock") },
	{ ...provenance, artifact: binary },
);
