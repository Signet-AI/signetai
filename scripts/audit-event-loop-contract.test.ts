...
test("the generated report describes the type boundary and transitional counts", () => {
	...
	expect(report).toContain("61 synchronous writes, 95 synchronous reads, and 159 async-named DB sites");
	...
	expect(report).toContain("Database accessor sites classified: 315");
	expect(report).toContain("ON-PARENT callback execution: 313");
