...
contextBridge.exposeInMainWorld("signetDesktop", {
	...
	getWorkspaceMigrationStatus: () => ipcRenderer.invoke("desktop:getWorkspaceMigrationStatus"),
	startWorkspaceMigration: () => ipcRenderer.invoke("desktop:startWorkspaceMigration"),
	rollbackWorkspaceMigration: () => ipcRenderer.invoke("desktop:rollbackWorkspaceMigration"),
