...
pub static FTS_STOP: LazyLock<HashSet<&'static str>> = LazyLock::new(|| {
    [
        ...
        "these", "those", "think", "thinking", "thought", "am", "also",
        "any", "much", "many", "like", "recommend", "recommends",
        "recommended", "recommendation", "recommendations", "suggest",
        "suggests", "suggested", "suggestion", "suggestions",
    ]
    .into_iter()
    .collect()
});
