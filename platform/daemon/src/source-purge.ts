import { SOURCE_CHUNK_SOURCE_TYPE, resolveDefaultBasePath } from "@signet/core";
...
export async function purgeSourceOwnedRows(input: PurgeSourceOwnedRowsInput): Promise<number> {
	...
	// Source ids are normally generated by the import route, but ledger rows are
	// durable input. Reject path separators and traversal markers before using an
	// id in the filesystem fallback; the ledger paths remain independently gated
	// by purgeTranscriptImportFilesystem.
