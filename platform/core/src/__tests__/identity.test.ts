...
describe("detectExistingSetup", () => {
	...
	test("detects current Kimi CLI from the default ~/.kimi config path", () => {
		process.env.HOME = TMP;
		// biome-ignore lint/performance/noDelete: assigning undefined stores the string "undefined"
		delete process.env.KIMI_SHARE_DIR;
		// biome-ignore lint/performance/noDelete: assigning undefined stores the string "undefined"
		...
		writeFileSync(join(TMP, ".kimi", "config.toml"), "# config\n");
	...
	test("detects legacy Kimi Code from the default ~/.kimi-code config path", () => {
		process.env.HOME = TMP;
		// biome-ignore lint/performance/noDelete: assigning undefined stores the string "undefined"
		delete process.env.KIMI_SHARE_DIR;
		// biome-ignore lint/performance/noDelete: assigning undefined stores the string "undefined"
