...
- [KNOWLEDGE-GRAPH.md](/knowledge-graph/) — graph data model that skill nodes
  participate in
- [KNOWLEDGE-ARCHITECTURE.md](/knowledge-architecture/) — conceptual rationale
  for the procedural memory tier
- [SKILLS.md](/skills/) — user-facing skills documentation (install, browse,
  search)
