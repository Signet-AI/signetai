...
description: "The lesson from Obsidian is that people should own the shape of their thinking, with markdown as one practical way to keep that structure inspectable. That is the posture AI memory systems need."
date: 2026-05-11
author: "Nicholai"
...
The lesson from Obsidian is that people should own the shape of their thinking, with markdown as one practical way to keep that structure inspectable.
...
The agent should maintain the user's thinking system while preserving the user's ownership and judgment.


## From a vault to a workspace
