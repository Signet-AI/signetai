...
In Signet, a SQLite database on your machine is the source of truth for structured memory. Memories, workspace instructions, and [[skills]] stay local in formats you can inspect, back up, and version control.
