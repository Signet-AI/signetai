...
Signet fixes that by giving agents a persistent home. [[memory|Memory]] and [[secrets]] live there, independent of whichever model or harness happens to be running. Workspace instructions are part of that durable memory. The model is a guest: it reads what it needs, does its work, and writes back what it learned.
