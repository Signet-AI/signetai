...
// Architecture provenance: source=integrations/opencode/plugin
 ...
 * Architecture provenance: generatedBy=integrations/opencode/connector/scripts/embed-plugin.ts
