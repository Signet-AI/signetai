...
This project is indexed by GitNexus as **signetai** (22493 symbols, 52109 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/signetai/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/signetai/context` | Codebase overview, check index freshness |
| `gitnexus://repo/signetai/clusters` | All functional areas |
| `gitnexus://repo/signetai/processes` | All execution flows |
| `gitnexus://repo/signetai/process/{name}` | Step-by-step execution trace |
